import{s as i,f as n,g as r,u as c,j as l,i as p,x as t,d as w}from"../chunks/scheduler.a1a79cf5.js";import{S as h,i as m}from"../chunks/index.f0883218.js";function u(s){let e,o=`<div class="title">php8.2-fpm Error 13 (Permission denied / File not found)</div> <div class="content"><p>Error seperti ini bisanya terjadi karena <code>root</code> site berada di user yang berbeda
...
$ sudo systemctl restart php8.2-fpm</pre></li></ol> <p>Terima kasih semoga bermanfaat.</p></div>`;return{c(){e=n("section"),e.innerHTML=o,this.h()},l(a){e=r(a,"SECTION",{class:!0,"data-svelte-h":!0}),c(e)!=="svelte-c7kurw"&&(e.innerHTML=o),this.h()},h(){l(e,"class","svelte-1dw4ok8")},m(a,d){p(a,e,d)},p:t,i:t,o:t,d(a){a&&w(e)}}}class f extends h{constructor(e){super(),m(this,e,null,u,i,{})}}export{f as component};
